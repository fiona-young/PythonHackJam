...
from Quaificatin2009.WelcomeToCodeJamMap import WelcomeToCodeJamMap
import utilities
class TestWelcomeToCodeJamMap(TestCase):
...
welcome to codejam''')
    ...
    def testShortInput(self):
        ...
        welcome_to_code_jam = WelcomeToCodeJamMap(input,match_string)
